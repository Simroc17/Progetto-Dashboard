...
@section('title', 'Generate Stack - Font Icons')
...
<main id="js-page-content" role="main" class="page-content">
    ...
    @slot('item2') Stack Icons @endslot
    @slot('item3') Generate Stack @endslot
    @endcomponent
    <div class="subheader">
                ...
                <div class="panel-content">
                    <div class="row">
                        <div class="col-12 col-xl-auto">
                                <div class="d-flex align-items-center justify-content-center position-relative w-100 mb-g mb-xl-0" style="font-size: 250px; min-width: 301px; height: 351px; background: url({{URL::asset('img/backgrounds/bg-5.png')}}); border-left:0; border-top:0; ">
