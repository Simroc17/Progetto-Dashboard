...
@section('content')
    <main id="js-page-content" role="main" class="page-content">
        ...
        @component('common-components.breadcrumb')
            ...
            @slot('item2') Autofill @endslot
        @endcomponent

        <div class="subheader">
            <h1 class="subheader-title">
                <i class='subheader-icon fal fa-table'></i> DataTables: <span class='fw-300'>Autofill</span> <sup
                ...
                <div id="panel-1" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                <p>The click-to-drag auto fill drag handle can be attached to the table cells using a
                                    number of different methods, depending on how you wish the end user to interact with
                                    your table. This option provides the ability to switch between the various options
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <code>focus</code> - Display when a cell gains focus - for integration with
                                        KeyTable
                                    </li>
                                    <li>
