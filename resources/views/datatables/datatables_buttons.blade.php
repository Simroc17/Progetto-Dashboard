...
@section('title', 'Buttons - Datatables')
    ...
    <div class="row">
        <div class="col-xl-12">
            <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2>
                        Volantini publicati nell'intervallo: <span class="ml-1" id="dataInizio"></span> 
                    </h2>
                    <div class="panel-toolbar">
                    ...
                    <div class="table-list-container " id="users">
                        ...
                        <table id="intestazione" style="display: none;" class="table table-hover table-striped w-100 mt-1">
                            ...
                            <tr class="text-white" role="row" style="background-color: red;">
                                    <th tabindex="0" rowspan="1" colspan="1" style="width: 5%;" ><button type="button" class="sort" data-sort="nome">Loghi</button></th>
                                    <th tabindex="0" rowspan="1" colspan="1" style="width: 5%;" ><button type="button" class="sort" data-sort="nome">Market</button></th>
                                    <th tabindex="0" rowspan="1" colspan="1" style="width: 5%;" ><button type="button" class="sort" data-sort="id">Volantino</button></th>
                                    ...
                                    <th tabindex="0" rowspan="1" colspan="1" style="width: 10%;" ><button type="button" class="sort" data-sort="date_start">Data inizio<i class="caret"></i></button></th>
                                    <th tabindex="0" rowspan="1" colspan="1" style="width: 10%;" ><button type="button" class="sort" data-sort="date_end">Data fine<i class="caret"></i></button></th>
...
<script>
    ...
    var monkeyList = new List('test-list', {
        valueNames: ['id' ,'nome', 'descrizione', 'date_start',  'date_end'],
        page: 10,
        pagination: {
            innerWindow: 1,
            left: 0,
...
<script>
    $(document).ready(function() {
        ...
        $('#bottone').on('click', function() {
            ...
            $.ajax({
                url: "/datatables/datatables_buttons",
                type: "GET",
                data: {
                    'category': category,
                    'dateStart': dateStart,
...
<style>
    ...
    .img75 {
        background-image: url('{{asset("img/decoNuova.png")}}');
    ...
    .img92 {
        background-image: url('{{asset("img/sebonNuova.png")}}');
        background-size: 60px;
        background-position: center;
        background-repeat: no-repeat;
        background-position-x: center;
    ...
    .img141 {
        background-image: url('{{asset("img/ayokaNuova.png")}}');
        background-size: 60px;
        background-position: center;
        background-repeat: no-repeat;
        background-position-x: center;
