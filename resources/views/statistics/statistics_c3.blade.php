...
@section('title', 'C3 Charts - Statistics')
...
<script src="{{ URL::asset('js/statistics/d3/d3.js')}}"></script>
<!-- c3 charts : MIT license -->
<script src="{{ URL::asset('js/statistics/c3/c3.js')}}"></script>
<script src="{{ URL::asset('js/statistics/demo-data/demo-c3.js')}}"></script>
<script>
