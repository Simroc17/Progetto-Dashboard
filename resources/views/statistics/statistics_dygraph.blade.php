...
@section('title', 'Dygraph - Statistics')

@section('headerStyle')
<link rel="stylesheet" media="screen, print" href="{{ URL::asset('css/statistics/dygraph/dygraph.css')}}">
@stop
...
<script src="{{ URL::asset('js/statistics/demo-data/demo-data-dygraph.js')}}"></script>
<!-- plugin dygraph.js : MIT license -->
<script src="{{ URL::asset('js/statistics/dygraph/dygraph.js')}}"></script>
<script>
