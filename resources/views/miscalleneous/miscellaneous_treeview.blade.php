...
@section('title', 'Tree View - Miscellaneous')

@section('headerStyle')
<link rel="stylesheet" media="screen, print" href="{{ URL::asset('css/miscellaneous/treeview/treeview.css') }}">
@stop
...
<script src="{{ URL::asset('js/miscellaneous/treeview/treeview.js') }}"></script>
<script>
