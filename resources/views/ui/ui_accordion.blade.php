...
@section('title', 'Accordion - UI Components')
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-title collapsed" data-toggle="collapse" data-target="#js_demo_accordion-6b" aria-expanded="false">
                                        <div class="d-flex flex-row align-items-center">
                                            <span class="mr-2">
                                                <img src="{{ URL::asset('/img/demo/avatars/avatar-j.png') }}" class="rounded-circle profile-image" alt="Jessica Milano">
                                            </span>
                                            <div class="info-card-text">
