...
@section('title', 'Cards - UI Components')
        ...
        <div class="d-flex flex-start w-100">
            ...
            <div class="d-flex flex-fill">
                <div class="flex-fill">
                    ...
                    <p>Cards are built with as little markup and styles as possible, but still manage to deliver a ton of control and customization. Built with flexbox, they offer easy alignment and mix well with other Bootstrap components. They have no <code>margin</code> by default, so use spacing utilities as needed. Although cards are a lightweight solution for 'widget' or 'panel', we recommend you check out SmartAdmin's <a href="/#" title="Components Panels" target="_blank">panels page</a> for further flexible and an alternative option.</p>
                ...
                <div class="panel-container show">
                    <div class="panel-content">
                        ...
                        <div class="card border m-auto m-lg-0" style="max-width: 18rem;">
                            <img src="{{URL::asset('/img/card-backgrounds/cover-3-lg.png')}}" class="card-img-top" alt="...">
                            <div class="card-body">
