...
@section('title', 'Badges - UI Components')
                    ...
                    <div class="panel-content">
                        ...
                        <div class="demo">
                            <span class="status d-inline-block">
                                <img src="{{ URL::asset('/img/demo/avatars/avatar-c.png') }}" class="profile-image rounded-circle" alt="...">
                            </span>
                        ...
                        <div class="demo">
                            <span class="status status-sm d-inline-block">
                                <img src="{{ URL::asset('/img/demo/avatars/avatar-c.png') }}" class="profile-image profile-image-md rounded-circle" alt="...">
                            </span>
        ...
        <div class="col-xl-6">
            ...
            <div id="panel-8" class="panel">
                ...
                <div class="panel-container show">
                    <div class="panel-content">
                        <div class="panel-tag">
                            Use the included <a href="/#" target="_blank">color utilities</a> to change background and text colors. Below are examples of nested badge with different background colors
                        </div>
                        <div class="frame-wrap">
                            <div class="demo">
