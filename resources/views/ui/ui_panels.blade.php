...
@section('title', 'Panels - UI Components')
...
<main id="js-page-content" role="main" class="page-content">
    ...
    <div class="alert alert-primary alert-dismissible">
        ...
        <br>
        <br>
        Give your users access to create panel settings using localstorage. You can change colors, remember collapse state, lock location, and add drag functions to panels. Be sure to check out the our exclusive <a href="{{URL('plugins/plugins_smartpanels')}}" target="_blank">SmartPanels</a> plugin.
    </div>
    <div class="row">
        <div class="col-xl-6">
        ...
        <div class="col-xl-6">
            <div id="panel-8" class="panel">
                ...
                <div class="panel-container show">
                    <div class="panel-content">
                        <div class="panel-tag">
                            You may place badge inside <code>.panel-toolbar</code>, <code>.panel-content</code> and <code>.panel-hdr</code>. Check out the <a href="/#" target="_blank">badge page</a> to learn more about badges
                        </div>
                    </div>
