...
@section('title', 'Build Notes - Application Intel')
    ...
    <div class="card mb-g">
        <div class="card-body">
            ...
            <ul class="nav d-block fs-md pl-3">
                ...
                <li>
                    <span class="badge bg-success-700 fw-n mr-1 width-3">FICN</span> Updated Fontawesome Pro packages adding the all new <a href="#" target="_blank">DuoTone icons</a> now with a total of 7500+ icons to choose from
                </li>
            </ul>
            <hr class="mt-4 mb-g">
            <h4 class="mb-g">
            ...
            <ul class="nav d-block fs-md pl-3">
                ...
                <li>
                    <span class="badge badge-primary fw-n mr-1 width-3">SCRP</span> Added _modules for SmartAdmin Laravel Core
                </li>
                <li>
