...
@section('title', 'Introduction - Application Intel')
...
<main id="js-page-content" role="main" class="page-content">
    ...
    <div class="d-flex flex-wrap demo demo-h-spacing mt-3 mb-3">
        <div class="rounded-pill bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
            <img src="{{ URL::asset('/img/demo/authors/sunny.png') }}" alt="Sunny A." class="img-thumbnail img-responsive rounded-circle" style="width:5rem; height: 5rem;">
            <div class="ml-2 mr-3">
                <h5 class="m-0">
        ...
        <div class="rounded-pill bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
            <img src="{{ URL::asset('/img/demo/authors/josh.png') }}" alt="Jos K." class="img-thumbnail img-responsive rounded-circle" style="width:5rem; height: 5rem;">
            <div class="ml-2 mr-3">
                <h5 class="m-0">
        ...
        <div class="rounded-pill bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
            <img src="{{ URL::asset('/img/demo/authors/jovanni.png') }}" alt="Jovanni Lo" class="img-thumbnail img-responsive rounded-circle" style="width:5rem; height: 5rem;">
            <div class="ml-2 mr-3">
                <h5 class="m-0">
        ...
        <div class="rounded-pill bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
            <img src="{{ URL::asset('/img/demo/authors/roberto.png') }}" alt="Jovanni Lo" class="img-thumbnail img-responsive rounded-circle" style="width:5rem; height: 5rem;">
            <div class="ml-2 mr-3">
                <h5 class="m-0">
        ...
        <div class="rounded-pill bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
            <img src="{{ URL::asset('/img/demo/authors/themesbrand.jpg') }}" alt="themesbrand" class="img-thumbnail img-responsive rounded-circle" style="width:5rem; height: 5rem;">
            <div class="ml-2 mr-3">
                <h5 class="m-0">
                    Rajesh K (Laravel Developer)
                    <small class="m-0 fw-300">
                        Partner &amp; Contributor
                    </small>
                </h5>
                <a href="https://twitter.com/@themesbrand" class="text-info fs-sm" target="_blank">@themesbrand</a> -
                <a href="https://wrapbootstrap.com/user/themesbrand" class="text-info fs-sm" target="_blank" title="Contact Themesbrand"><i class="fal fa-envelope"></i></a>
            </div>
        </div>
    </div>
    <p class="fs-lg">
