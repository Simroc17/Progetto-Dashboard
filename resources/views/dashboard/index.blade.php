...
<link rel="stylesheet" media="screen, print" href="{{ URL::asset('css/miscellaneous/reactions/reactions.css') }}">
...
<script src="{{ URL::asset('js/statistics/sparkline/sparkline.bundle.js') }}"></script>
...
<script src="{{ URL::asset('js/miscellaneous/jqvmap/jqvmap.bundle.js') }}"></script>
<script>
