...
<main id="js-page-content" role="main" class="page-content">
    ...
    <div class="subheader">
        ...
        <div class="subheader-block d-lg-flex align-items-center">
            <div class="d-flex mr-4">
                @component('common-components.graph-widget')
                @slot('value') 7/10 @endslot
                @slot('title') New Sessions @endslot
                @slot('percentage') 70.60% @endslot
                @slot('fill') [&quot;#967bbd&quot;, &quot;#ccbfdf&quot;] @endslot
                @endcomponent
            </div>

            <div class="d-flex mr-0">
                @component('common-components.graph-widget')
                @slot('value') 3/10 @endslot
                @slot('title') Page Views @endslot
                @slot('percentage') 14,134 @endslot
                @slot('fill') [&quot;#2196F3&quot;, &quot;#9acffa&quot;] @endslot
                @endcomponent
            </div>
        </div>
    </div>
    <div class="row justify-content-between">
    <div style="font-size: 20px;" class="col-5"> <i class="fa-solid fa-bomb"></i></div>
        <div class="col-5">
    ...
    <div style="font-size: 15px; margin-bottom:1rem;"><i class="fa-regular fa-clock"></i> </div>
...
<script src="{{ URL::asset('js/statistics/peity/peity.bundle.js') }}"></script>
<script src="{{ URL::asset('js/statistics/flot/flot.bundle.js') }}"></script>
<script src="{{ URL::asset('js/statistics/easypiechart/easypiechart.bundle.js') }}"></script>
