...
@section('title', 'SweetAlert2 - Notifications')

@section('headerStyle')
<link rel="stylesheet" media="screen, print" href="{{ URL::asset('css/notifications/sweetalert2/sweetalert2.bundle.css') }}">
...
<main id="js-page-content" role="main" class="page-content">
    ...
    @slot('item1') Notifications @endslot
    @slot('item2') SweetAlert2 @endslot
    @endcomponent
...
<script src="{{ URL::asset('js/notifications/sweetalert2/sweetalert2.bundle.js') }}"></script>
<script>
