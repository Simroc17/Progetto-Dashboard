...
@section('title', 'Helpers - Utilities')
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            ...
                            <div>
                                ...
                                <img src="{{URL::asset('img/demo/avatars/ng.jpg')}}" class="rounded-circle width-3 h-auto opacity-5" id="js_opacity" alt="">
                            </div>
                        </div>
                    </div>
                </div>
