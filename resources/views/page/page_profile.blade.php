...
@section('title', 'Profile - Page Views')
                ...
                <div class="row no-gutters row-grid">
                    <div class="col-12">
                        <div class="d-flex flex-column align-items-center justify-content-center p-4">
                            <img src="{{ URL::asset('/img/demo/avatars/avatar-admin-lg.png') }}" class="rounded-circle shadow-2 img-thumbnail" alt="">
            ...
            <div class="card mb-g">
                <div class="card-body pb-0 px-4">
                    ...
                    <div class="pb-3 pt-2 border-top-0 border-left-0 border-right-0 text-muted">
                        ...
                        <img src="{{ URL::asset('/img/demo/gallery/46.jpg') }}" class="img-fluid" alt="">
                    </div>
                    <div class="d-flex align-items-center demo-h-spacing py-3">
                        <a href="javascript:void(0);" class="d-inline-flex align-items-center text-dark">
