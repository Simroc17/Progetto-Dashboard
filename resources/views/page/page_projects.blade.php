...
@section('title', 'Project - Page Views')
@section('headerStyle')
                        ...
                        <table id="dt-basic-example" class="table table-bordered table-hover w-100">
                            ...
                            <tbody>
                                <tr>
                                    <td>A1001</td>
                                    <td>
                                        <a href="page_projects.html" class="fs-lg text-dark">Frontend Design & Framework</a>
                                        <br>
                                    ...
                                    <td>
                                        <div class="fs-sm d-flex align-items-center flex-row-reverse">
                                            <a href="#" class="btn-m-s">
                                                <img src="{{URL::asset('img/demo/avatars/avatar-a.png')}}" class="profile-image-sm rounded-circle" alt="aa">
                                            </a>
                                            <a href="#" class="btn-m-s">
                                                <img src="{{URL::asset('img/demo/avatars/avatar-b.png')}}" class="profile-image-sm rounded-circle" alt="aa">
                                            </a>
                                            <a href="#" class="btn-m-s">
                                                <img src="{{URL::asset('img/demo/avatars/avatar-c.png')}}" class="profile-image-sm rounded-circle" alt="aa">
                                            </a>
                                            <a href="#" class="btn-m-s">
                                                <img src="{{URL::asset('img/demo/avatars/avatar-e.png')}}" class="profile-image-sm rounded-circle" alt="aa">
                                            </a>
                                            <a href="#" class="btn-m-s">
                                                <img src="{{URL::asset('img/demo/avatars/avatar-h.png')}}" class="profile-image-sm rounded-circle" alt="aa">
                                            </a>
                                            <a href="#" class="btn-m-s">
                                                <img src="{{URL::asset('img/demo/avatars/avatar-k.png')}}" class="profile-image-sm rounded-circle" alt="aa">
                                            </a>
                                            <a href="#" class="btn-m-s fs-xs">
                                                <span data-hasmore="+7" class="rounded-circle profile-image-sm">
                                                    <img src="{{URL::asset('img/demo/avatars/avatar-j.png')}}" class="profile-image-sm rounded-circle" alt="aa">
                                                </span>
                                            </a>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="fs-sm d-flex align-items-center flex-row-reverse">
                                            ...
                                            <a href="#" class="btn-m-s">
                                                <img src="{{URL::asset('img/demo/avatars/avatar-g.png')}}" class="profile-image-sm rounded-circle" alt="aa">
                                            </a>
                                            <a href="#" class="btn-m-s">
                                                <img src="{{URL::asset('img/demo/avatars/avatar-i.png')}}" class="profile-image-sm rounded-circle" alt="aa">
                                            </a>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>A1003</td>
                                    <td>
                                        <a href="page_projects.html" class="fs-lg text-dark">AngularJS UI design and development</a>
                                        <br>
                                    ...
                                    <td>
                                        <div class="fs-sm d-flex align-items-center flex-row-reverse">
                                            ...
                                            <a href="#" class="btn-m-s">
                                                <img src="{{URL::asset('img/demo/avatars/avatar-m.png')}}" class="profile-image-sm rounded-circle" alt="aa">
                                            </a>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="fs-sm d-flex align-items-center flex-row-reverse">
                                            <a href="#" class="btn-m-s">
                                                <img src="{{URL::asset('img/demo/avatars/avatar-f.png')}}" class="profile-image-sm rounded-circle" alt="aa">
                                            </a>
                                            <a href="#" class="btn-m-s">
                                                <img src="{{URL::asset('img/demo/avatars/avatar-h.png')}}" class="profile-image-sm rounded-circle" alt="aa">
                                            </a>
                                            ...
                                            <a href="#" class="btn-m-s">
                                                <img src="{{URL::asset('img/demo/avatars/avatar-d.png')}}" class="profile-image-sm rounded-circle" alt="aa">
                                            </a>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>A1006</td>
                                    <td>
                                        <a href="page_projects.html" class="fs-lg text-dark">Create filters and directives</a>
                                        <br>
                                ...
                                <tr>
                                    <td>A1008</td>
                                    <td>
                                        <a href="page_projects.html" class="fs-lg text-dark"><strong>Phase 1:</strong> Modual implimentations</a>
                                        <br>
                                ...
                                <tr>
                                    <td>A1009</td>
                                    <td>
                                        <a href="page_projects.html" class="fs-lg text-dark"><strong>Phase 2:</strong> Beta testing</a>
                                        <br>
                                ...
                                <tr>
                                    <td>A1010</td>
                                    <td>
                                        <a href="page_projects.html" class="fs-lg text-dark"><strong>Phase 3:</strong> Deploy to management</a>
                                        <br>
                                ...
                                <tr>
                                    <td>A1011</td>
                                    <td>
                                        <a href="page_projects.html" class="fs-lg text-dark">Preliminary studies of client intel</a>
                                        <br>
                                ...
                                <tr>
                                    <td>A1012</td>
                                    <td>
                                        <a href="page_projects.html" class="fs-lg text-dark">Prepare property management contracts</a>
                                        <br>
                                ...
                                <tr>
                                    <td>A1013</td>
                                    <td>
                                        <a href="page_projects.html" class="fs-lg text-dark">Publish to Wrapbootstrap</a>
                                        <br>
                                ...
                                <tr>
                                    <td>A1015</td>
                                    <td>
                                        <a href="page_projects.html" class="fs-lg text-dark">Refurbish Architecture</a>
                                        <br>
                                ...
                                <tr>
                                    <td>A1018</td>
                                    <td>
                                        <a href="page_projects.html" class="fs-lg text-dark">Upgrade to windows 8.1</a>
                                        <br>
                                        <small class="text-muted">Created 14.08.2020</small>
                                    </td>
                                    <td>75</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="fs-sm d-flex align-items-center flex-row-reverse">
                                            <a href="#" class="btn-m-s">
                                                <img src="{{URL::asset('img/demo/avatars/avatar-admin.png')}}" class="profile-image-sm rounded-circle" alt="aa">
                                            </a>
                                        </div>
                                    </td>
                                </tr>
