...
<main id="js-page-content" role="main" class="page-content">
    ...
    @slot('item2') Forum Layouts @endslot
    @slot('item3') Item @endslot
    @endcomponent
    <div class="subheader">
        ...
        <div class="col-xl-12">
                ...
                <div class="card-header p-0">
                    <div class="p-3 d-flex flex-row">
                        <div class="d-block flex-shrink-0">
                            <img src="{{ URL::asset('/img/demo/avatars/avatar-admin.png') }}" class="img-fluid img-thumbnail" alt="">
                        </div>
            ...
            <div class="card mb-g border shadow-0">
                <div class="card-header p-0">
                    <div class="p-3 d-flex flex-row">
                        <div class="d-block flex-shrink-0">
                            <img src="{{ URL::asset('/img/demo/avatars/avatar-b.png') }}" class="img-fluid img-thumbnail" alt="">
                        </div>
                        <div class="d-block ml-2">
            ...
            <div class="card mb-g border shadow-0">
                <div class="card-header p-0">
                    <div class="p-3 d-flex flex-row">
                        <div class="d-block flex-shrink-0">
                            <img src="{{ URL::asset('/img/demo/avatars/avatar-e.png') }}" class="img-fluid img-thumbnail" alt="">
                        </div>
                        <div class="d-block ml-2">
                            <span class="h6 font-weight-bold text-uppercase d-block m-0">RE: Package location</span>
            ...
            <div class="card mb-g border shadow-0">
                <div class="card-header p-0">
                    <div class="p-3 d-flex flex-row">
                        <div class="d-block flex-shrink-0">
                            <img src="{{ URL::asset('/img/demo/avatars/avatar-h.png') }}" class="img-fluid img-thumbnail" alt="">
                        </div>
                        <div class="d-block ml-2">
                            <span class="h6 font-weight-bold text-uppercase d-block m-0">RE: Package location</span>
