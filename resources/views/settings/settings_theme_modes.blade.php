...
@section('title', 'Layout Options - Theme Modes')

@section('content')
<main id="js-page-content" role="main" class="page-content">

    @component('common-components.breadcrumb')
    @slot('item1') Theme Modes @endslot
    @slot('item2') Layout Options @endslot
    @endcomponent
    <div class="subheader">
                ...
                <div class="card-body">
                    ...
                    <div class="demo-window rounded mb-g shadow-1 m-auto" style="max-width:650px">
                        <div class="demo-window-content">
                            <!-- content -->
                            <img src="{{ URL::asset('img/demo/modes/mode-light-lg.png') }}" class="img-fluid" alt="Light Mode">
                        </div>
                    </div>
                    <p class="text-center">
            ...
            <div class="card mb-g">
                <div class="card-body">
                    ...
                    <div class="demo-window rounded mb-g shadow-1 m-auto" style="max-width:650px">
                        <div class="demo-window-content">
                            <!-- content -->
                            <img src="{{ URL::asset('img/demo/modes/mode-dark-lg.png') }}" class="img-fluid" alt="Dark Mode">
                        </div>
                    </div>
                    <p class="text-center">
            ...
            <div class="card mb-g">
                <div class="card-body">
                    ...
                    <div class="demo-window rounded mb-g shadow-1 m-auto" style="max-width:650px">
                        <div class="demo-window-content">
                            <!-- content -->
                            <img src="{{ URL::asset('img/demo/modes/mode-default-lg.png') }}" class="img-fluid" alt="Default Mode">
                        </div>
                    </div>
                    <p class="text-center">
            ...
            <div class="card mb-g">
                <div class="card-body">
                    ...
                    <div class="demo-window rounded mb-g shadow-1 m-auto" style="max-width:650px">
                        <div class="demo-window-content">
                            <!-- content -->
                            <img src="{{ URL::asset('img/demo/modes/mode-glass-lg.png') }}" class="img-fluid" alt="Glass Mode (coming soon)">
                        </div>
                    </div>
                    <p class="text-center">
