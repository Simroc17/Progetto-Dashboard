...
@section('title', 'Skin Options - Theme Settings')
...
<main id="js-page-content" role="main" class="page-content">
    ...
    @slot('item1') Theme Settings @endslot
    @slot('item2') Skin Options @endslot
    @endcomponent
    <div class="subheader">
                ...
                <div class="card-body">
                    ...
                    <div class="demo-window rounded mb-g shadow-1 m-auto" style="max-width:550px">
                        <div class="demo-window-content">
                            <img src="{{ URL::asset('/img/demo/skins/black.png')}}" alt="dark">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-sm-12 col-lg-6 col-xl-6">
            <div class="card mb-g">
                <div class="card-body">
                    ...
                    <div class="demo-window rounded mb-g shadow-1 m-auto" style="max-width:550px">
                        <div class="demo-window-content">
                            <img src="{{ URL::asset('/img/demo/skins/blue.png')}}" alt="dark">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-sm-12 col-lg-6 col-xl-6">
            <div class="card mb-g">
                <div class="card-body">
                    ...
                    <div class="demo-window rounded mb-g shadow-1 m-auto" style="max-width:550px">
                        <div class="demo-window-content">
                            <img src="{{ URL::asset('/img/demo/skins/green.png')}}" alt="dark">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-sm-12 col-lg-6 col-xl-6">
            <div class="card mb-g">
                <div class="card-body">
                    ...
                    <div class="demo-window rounded mb-g shadow-1 m-auto" style="max-width:550px">
                        <div class="demo-window-content">
                            <img src="{{ URL::asset('/img/demo/skins/pink.png')}}" alt="dark">
                        </div>
                    </div>
                </div>
            </div>
